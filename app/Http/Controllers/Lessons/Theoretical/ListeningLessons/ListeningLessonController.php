...
namespace App\Http\Controllers\Lessons\Theoretical\ListeningLessons;
...
class ListeningLessonController extends Controller
{
 /**
    ...
    {
        return response()->json(ListeningLesson::all(), 200);
    }
    ...
    {
        $lesson = ListeningLesson::find($id);
        if (!$lesson) {
    ...
    {
        $lessons = ListeningLesson::where('emailTeacher', $emailTeacher)->get();
    ...
    {
        $lessons = ListeningLesson::where('codigoLingua', $codigoLingua)->get();
