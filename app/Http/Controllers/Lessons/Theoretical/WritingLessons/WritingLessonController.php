...
use App\Models\Lessons\Theoretical\Writing\WritingLesson;
...
class WritingLessonController extends Controller
{
    ...
    {
        return response()->json(WritingLesson::all(), 200);
    }
    ...
    {
        $lessons = WritingLesson::where('emailTeacher', $emailTeacher)->get();
    ...
    {
        $lessons = WritingLesson::where('codigoLingua', $codigoLingua)->get();
